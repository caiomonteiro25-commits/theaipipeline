...
name: artwork-specs
description: >
  Dimensões, resolução, formato e restrições de conteúdo de arte de capa por plataforma: Spotify, Apple, Deezer, YouTube. Complementa: metadata-setup, delivery-checklist, release-setup.
area: musica-juridico-distribuicao
complementa: metadata-setup, delivery-checklist, release-setup
---
# artwork-specs
...
## Quando usar
Dimensões, resolução, formato e restrições de conteúdo de arte de capa por plataforma: Spotify, Apple, Deezer, YouTube.
